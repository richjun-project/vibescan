    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none
          ...
          prose-code:text-blue-600 prose-code:bg-blue-50 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:before:content-none prose-code:after:content-none prose-code:font-mono
          prose-pre:bg-gray-900 prose-pre:text-gray-100 prose-pre:p-6 prose-pre:rounded-xl prose-pre:shadow-lg prose-pre:overflow-x-auto prose-pre:text-sm prose-pre:my-10 prose-pre:leading-relaxed
          prose-ul:list-disc prose-ul:pl-6 prose-ul:mb-6 prose-ul:space-y-2 prose-ul:text-gray-700
          prose-ol:list-decimal prose-ol:pl-6 prose-ol:mb-6 prose-ol:space-y-2 prose-ol:text-gray-700
          prose-li:marker:text-gray-400
          prose-blockquote:border-l-4 prose-blockquote:border-blue-500 prose-blockquote:pl-6 prose-blockquote:py-2 prose-blockquote:my-10 prose-blockquote:italic prose-blockquote:text-gray-700 prose-blockquote:bg-gray-50 prose-blockquote:rounded-r-lg
          prose-img:rounded-xl prose-img:shadow-xl prose-img:my-12 prose-img:w-full
