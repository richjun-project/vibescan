...
var AuthService = /** @class */ (function () {
    function AuthService(userRepository, em, jwtService) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.em.persistAndFlush(user)];
                    case 2:
                        _a.sent();
    ...
    AuthService.prototype.oauthLogin = function (profile) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.userRepository.findOne({ email: profile.email })];
                    case 2:
                    ...
                    case 5:
                        _a.sent();
                        _a.label = 6;
                    case 6: return [2 /*return*/, this.generateToken(user)];
                }
            });
        });
    };
    AuthService.prototype.generateToken = function (user) {
        var payload = { sub: user.id, email: user.email, role: user.role };
        return {
